...
const Saved = () => {
    ...
    const savedBlogs = blogs.filter((blog) => blog.authorId === id && blog.saved === true);

    console.log("likedBlogs", savedBlogs);
    

    

    return (
        (savedBlogs === null || savedBlogs === undefined || savedBlogs.length <= 0) ? 
        (<div className="flex justify-center items-center h-[70vh] w-[100vw] text-xl flex-col">
            <p>You Have Not Saved Any Blogs</p> 
        ...
        savedBlogs.map((blog) => {
            return (
            <div className="lg:p-10 md:max-w-[80vw] max-w-[100vw] mx-auto flex flex-col items-center justify-normal" key={blog.id}>
